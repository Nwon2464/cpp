...
template <typename T>
void ndarray(vector<T>& vec, int len, T init) {
     vec.assign(len, init);
}
...
// break;
//}
// if(--req[_s[need++]]== 0){ // we found the one in the map
// still_req++;
//}
//}
// else{
// when pointer comes here, it finds all, now it starts to
// find minimum length
// if(req[_s[first++]]++ == 0){
// still_req--;
//}
//}
// if(still_req == memosz ){
// ans = min(ans, mp(need - first, first));
//}
...
//}
// else{
// cout << _s.substr(ans.second,ans.first);
//}
